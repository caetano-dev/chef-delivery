...
struct HomeService{
    ...
    func fetchDataWithAlamofile(completion: @escaping ([StoreType]?, Error?) -> Void){
        AF.request("https://private-36f463-pedrocaetano.apiary-mock.com/home").responseDecodable(of: [StoreType].self) { response in
