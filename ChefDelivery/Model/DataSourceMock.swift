...
let ordersMock: [OrderType] = [
    ...
    OrderType(id: 4, name: "Petshop", image: "petshop"),
...
let storesMock: [OrderType] = [
    ...
    OrderType(id: 4, name: "Carbron", image: "carbron-logo"),
    OrderType(id: 5, name: "Padaria", image: "bakery-logo"),
    OrderType(id: 6, name: "Açaí Panda", image: "acai-panda-logo"),
]
